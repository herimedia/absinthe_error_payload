defmodule AbsintheErrorPayload.TestHelper do
  @moduledoc """
  ...
  Optionally pass a subset of fields to compare - by default all `AbsintheErrorPayload.ValidationMessage` fields are included,
